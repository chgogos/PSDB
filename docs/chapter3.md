...
*   **Προσωρινοί και Ασφαλείς**: Κάθε κωδικός κοινής χρήσης συνδέεται μοναδικά με ένα συγκεκριμένο αρχείο εξαγωγής. Οι κωδικοί είναι προσωρινοί και ενδέχεται να λήξουν μετά από κάποιο χρονικό διάστημα.
...
## 3.4 Εξαγωγή Δεδομένων PISA μέσω Κωδικού Κοινής Χρήσης (Χωρίς Σύνδεση)
...
## 3.5 Τάσεις Μεταβλητών Ανά Κύκλο
...
## 3.6 Σύγκριση Δεδομένων Μαθητών-Σχολείων
...
## 3.7 Αναζήτηση & Ανακάλυψη Στηλών
...
## 3.8 Οπτικοποίηση Δεδομένων Χωρών
...
## 3.9 Προσαρμοσμένα Ερωτήματα SQL
...
## 3.10 Πίνακας Διαχείρισης Διαχειριστή
