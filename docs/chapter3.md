...
!!! note "Σημείωση"
    Η λειτουργία αυτή είναι ιδανική για περιπτώσεις όπου ένας συνδεδεμένος χρήστης δημιουργεί μια εξαγωγή δεδομένων μέσω του Οδηγού Εξαγωγής (ενότητα 3.3) και στη συνέχεια κοινοποιεί τον κωδικό σε τρίτους, οι οποίοι μπορούν να κατεβάσουν τα δεδομένα χωρίς να χρειάζεται να δημιουργήσουν λογαριασμό.
